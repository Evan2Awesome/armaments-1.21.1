...
public class ModDataComponents {
    ...
    public static final ComponentType<AmmoPouchComponent> AMMO_POUCH = register("ammo_pouch", builder -> builder.codec(AmmoPouchComponent.CODEC).packetCodec(AmmoPouchComponent.PACKET_CODEC).cache());
